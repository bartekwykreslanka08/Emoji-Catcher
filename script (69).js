...
const modes = {
    ...
    medium: { initialTime: 30, goodPoints: [5, 6, 7, 6, 5, 7, 6, 5, 7, 6, 5, 7, 6], goodTime: [5, 6, 9, 7, 6, 8, 7, 6, 8, 7, 6, 9, 7], badPoints: [-6], badTime: [-7], emojiInterval: 600, bombChance: 0.4, magnetChance: 0.08 },
    hard: { initialTime: 15, goodPoints: [6, 7, 8, 7, 6, 8, 7, 6, 8, 7, 6, 8, 7], goodTime: [6, 7, 9, 8, 7, 9, 8, 7, 9, 8, 7, 9, 8], badPoints: [-7], badTime: [-8], emojiInterval: 400, bombChance: 0.6, magnetChance: 0.06 }
};
