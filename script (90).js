...
function checkCollisions() {
    ...
    emojis.forEach(emoji => {
        ...
        const collisionHeight = playerRect.height;
        ...
        if (currentModifier === 'duet') {
            if ((Math.abs(emojiX - playerPosition) < collisionWidth &&
                ...
                (secondPlayerRect && Math.abs(emojiX - secondPlayerPosition) < collisionWidth &&
                 rect.bottom >= secondPlayerRect.top &&
                 rect.top <= secondPlayerRect.bottom &&
    ...
    if (magnetActive) {
        ...
        emojis.forEach(emoji => {
            ...
            if (distance < magnetRadius && verticalOverlap > 0) {
                ...
                const collisionWidth = (currentModifier === 'biggerBasket' ? playerWidth * 1.5 : currentModifier === 'miniBasket' ? playerWidth / 2 : playerWidth);
                if (Math.abs(emojiX - playerPosition) < collisionWidth / 2 &&
