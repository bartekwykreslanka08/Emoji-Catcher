...
function applyTheme(theme) {
    ...
    switch (theme) {
        case 'food':
            gameArea.style.background = 'linear-gradient(to bottom, #f5e8c7, #d9a66b)';
            break;
        case 'animals':
            gameArea.style.background = 'linear-gradient(to bottom, #87ceeb, #98fb98)';
            break;
        case 'vehicles':
            gameArea.style.background = 'linear-gradient(to bottom, #4b5e6a, #a3bffa)';
            break;
        default:
