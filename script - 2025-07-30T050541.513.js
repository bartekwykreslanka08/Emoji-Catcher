...
const modes = {
    ...
    hardPlus: { initialTime: 10, goodPoints: [7, 8, 9], goodTime: [7, 9, 10], badPoints: [-7], badTime: [-7], emojiInterval: 300, fallDuration: 1200, bombChance: 0.35, dollarChance: 0.015, zeroChance: 0.02 }
};
