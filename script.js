...
const moveSpeed = 15;
const magnetRadius = 30; // Zwiększono zasięg magnesu
const magnetPullStrength = 10; // Zwiększono siłę przyciągania
                            ...
                            if (player || secondPlayer) {
                                ...
                                if (magnetActive) {
                                    ...
                                    if (distance <= magnetRadius) {
                                        const pullSpeed = magnetPullStrength * (magnetRadius - distance) * deltaTime;
                                        if (emojiX < playerX) {
