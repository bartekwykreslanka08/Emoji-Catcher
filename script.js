...
function startGame() {
    if (!gameStarted && localStorage.getItem('loggedInUser_' + location.hostname)) {
        ...
        document.querySelector('.game-stats').style.display = 'block'; // Wyświetlane na samej górze od pierwszej gry
        document.getElementById('stopButton').style.display = 'inline-block'; // Wyświetlane na samej górze od pierwszej gry
        gameStarted = true;
        isPaused = false;
