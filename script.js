...
function startGame() {
    if (!gameStarted && localStorage.getItem('loggedInUser_' + location.hostname)) {
        ...
        gameArea.style.display = 'block'; // Wyświetlanie od pierwszej gry na środku
        document.querySelector('.game-stats').style.display = 'block'; // Wyświetlanie od pierwszej gry na środku góry
        document.getElementById('stopButton').style.display = 'inline-block'; // Wyświetlanie od pierwszej gry
        gameStarted = true;
        isPaused = false;
