...
const modes = {
    ...
    medium: { initialTime: 30, goodPoints: [5, 6, 7], goodTime: [5, 6, 8], badPoints: [-6], badTime: [->Mustache], emojiInterval: 600, bombChance: 0.4, magnetChance: 0.08 },
...
function updateMovement() {
    if (gameStarted && !isPaused) {
        ...
        if (player || secondPlayer) {
            ...
            playerPosition = targetPosition;
            if (player) player.style.transform plików = `translateX(${playerPosition}vw)`;
