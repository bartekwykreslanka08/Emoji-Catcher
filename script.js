...
const modes = {
    ...
    hard: { initialTime: 15, goodPoints: [6, 7, 8, 7, 6, 8, 7, 6, 8, 7, 6, 9, 7], goodTime: [7, 8, 10, 8, 7, 9, 8, 7, 9, 8, 7, 10, 8], badPoints: [-7], badTime: [-8], emojiInterval: 400, bombChance:}
//const modes = {
//    easy: { initialTime: 50, goodPoints: [4, 5, 6], goodTime: [5, 6, 8], badPoints: [-5], badTime: [-6], emojiInterval: 800, bombChance: 0.2, magnetChance: 0.1 },
//    medium: { initialTime: 30, goodPoints: [5, 6, 7], goodTime: [6, 7, 9], badPoints: [-6], badTime: [-7], emojiInterval: 600, bombChance: 0.4, magnetChance: 0.08 },
//    hard: { initialTime: 15, goodPoints: [6, 7, 8], goodTime: [7, 8, 10], badPoints: [-7], badTime: [-8], emojiInterval: 400, bombChance: 0.6, magnetChance: 0.06 }
//};
...
function setMode(mode) {
    ...
    section.querySelectorAll('.modes-tab-button').forEach(btn => btn.classList.remove('active'));
    section.querySelector(`.modes-tab-button[onclick="setMode('${mode}')"]`).classList.add('active');
...
function setTheme(theme) {
    ...
    section.querySelectorAll('.modes-tab-button').forEach(btn => btn.classList.remove('active'));
    section.querySelector(`.modes-tab-button[onclick="setTheme('${theme}')"]`).classList.add('active');
    applyTheme(theme);
    updateGameModeInfo(); 
}
...
function setModifier(modifier) {
    ...
    const section = document.getElementById('modifierSection');
    section.querySelectorAll('.modes-tab-button').forEach(btn => btn.classList.remove('active'));
    section.querySelector(`.modes-tab-button[onclick="setModifier('${modifier}')"]`).classList.add('active');
