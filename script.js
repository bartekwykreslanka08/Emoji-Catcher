...
function applyTheme(theme) {
    ...
    const backgrounds = {
        ...
        food: 'linear-gradient(to bottom, #FFD700, #FF4500)', // Nowe tło dla jedzenie
        animals: 'linear-gradient(to bottom, #90EE90, #228B22)', // Nowe tło dla zwierzęta
        vehicles: 'linear-gradient(to bottom, #C0C0C0, #696969)' // Nowe tło dla pojazdy
    };
