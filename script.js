...
function updateEmojiAnimation() {
    ...
    for (let emoji of emojis) {
        ...
        if (rect.bottom >= gameAreaRect.bottom) {
            ...
            currentTop += (100 / modes[currentMode].fallDuration) * deltaTime * 1000; // Poprawiona prędkość spadania
