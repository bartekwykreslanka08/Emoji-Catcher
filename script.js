...
let magnetTimeout;
let currentModifier = 'none'; // Domyślnie brak modyfikatora
...
function startGame() {
    if (!gameStarted && localStorage.getItem('loggedInUser_' + location.hostname)) {
        ...
        updateGameModeInfo(); // Aktualizacja napisu z trybem
...
function setMode(mode) {
    ...
    document.getElementById('time').textContent = time;
    updateGameModeInfo(); // Aktualizacja napisu po zmianie trybu
}
...
function setTheme(theme) {
    ...
    applyTheme(theme);
    updateGameModeInfo(); // Aktualizacja napisu po zmianie motywu
}
...
function setModifier(modifier) {
    ...
    document.getElementById('time').textContent = time;
    updateGameModeInfo(); // Aktualizacja napisu po zmianie modyfikatora
}
